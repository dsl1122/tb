...
#set terminal epslatex size 5,7 standalone color colortext 12
...
#set title "test"
#set size 0.5,0.49
set ylabel "Damping Rate (s$^{-1}$)"
set xlabel "Collision Rate (s$^{-1}$)"
     #set tics scale 1 font ",0" 
     #set xtics format " "

plot 'quaddamp2.csv' using 1:2:3 with yerrorbars pt 5 lt 1 ps 2.0 title "Monopole", \
     'quaddamp2.csv' using 1:4:5 with yerrorbars pt 7 lt 1 ps 2.0 title "Quadrupole"
#set size 0.5,0.39
     #set xtics nomirror
#unset xtics
#set xtics format "$%g$"
